         ...
         if (!Schema::hasTable($this->table)) {
			...
			Schema::table($this->table, function (Blueprint $table) {
				...
				if (!Schema::hasColumn($this->table, 'price')) {
					...
					$table->decimal('price',10,0)->nullable()->comment('{"form":{"label":"Price","sort":999,"key":"price","data_type":"decimal","value":"","type":"number"},"list":{"label":"Price","key":"price","data_type":"decimal"}}')->change();
				}
